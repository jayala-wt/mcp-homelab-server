...
def knowledge_ocr_queue(config, args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        with get_db_connection("knowledge") as conn:
            ...
            # +20 if year >= 2025
            # +10 if entity in {SparkleMaids4U, John}
            # +(access_count * 5)
            ...
            cursor.execute(
                ...
                SELECT
                    ...
                    (
                        ...
                        CASE WHEN entity IN ('SparkleMaids4U', 'John') THEN 10 ELSE 0 END +
